    ...
    <div>
        <vue-final-modal v-model="showModal" classes="modal-container"
            ...
            <div class="wrapper">
                    ...
                    <div class="padding-20 playlisteditor" @click="editPlaylist"
                        ...
                        <div class="details">
                            <div class="detailswrapper">
                                ...
                                <span
                                    v-if="href"
                                    class="material-symbols-rounded share"
                                    @click="share"
                                >share</span>
                                <span
                                    v-if="href"
                                    class="material-symbols-rounded share fill"
                                    @click="preview"
                                >play_arrow</span>
                            </div>
                            <h1>{{title}}</h1>
                ...
                <div class="confirm">
                    <mini-player v-if="track?.src" class="miniPlayer" :title="title" :artist="artist" :src="track.src" />
  ...
  components: { MiniPlayer },
        ...
        methods: {
            ...
            add() {
                ...
                console.log(track, this.exists, id)

                let body = this.exists ? {
                    source: this.href
                } : {
                    source: this.track.src,
                    title: this.title,
                    artist: this.artist,
